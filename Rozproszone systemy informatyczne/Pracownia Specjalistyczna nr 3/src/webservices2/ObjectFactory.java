...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://webservices/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://webservices/", "getHelloWorldAsString");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "getHelloWorldAsString")
